										...
										<div class="container">
											<div class="d-flex">
												...
												<a class="header-brand" href="index.html">
													<img src="{{URL::asset('assets/images/brand/logo.png')}}" class="header-brand-img" alt="Volgh logo">
												</a><!-- LOGO -->
												<div class="d-flex order-lg-2 mr-auto header-right-icons">
													...
													<div class="dropdown d-md-flex message">
														...
														<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
															<a href="#" class="dropdown-item d-flex mt-2 pb-3">
																<div class="avatar avatar-md brround ml-3 d-block cover-image" data-image-src="{{URL::asset('assets/images/users/4.jpg')}}">
															...
															<a href="#" class="dropdown-item d-flex pb-3">
																<div class="avatar avatar-md brround ml-3 d-block cover-image" data-image-src="{{URL::asset('assets/images/users/1.jpg')}}">
															...
															<a href="#" class="dropdown-item d-flex pb-3">
																<div class="avatar avatar-md brround ml-3 d-block cover-image" data-image-src="{{URL::asset('assets/images/users/18.jpg')}}">
										...
										<div class="horizontal-mainwrapper container clearfix">
											<nav class="horizontalMenu clearfix">
												<ul class="horizontalMenu-list">
													<li aria-haspopup="true"><a href="#" class="sub-icon border-right-0"><i class="fa fa-laptop"></i> Dashboard <i class="horizontal-icon fa fa-angle-down"></i></a>
														<ul class="sub-menu">
									...
									<div class="header header-2 p-4">
										<div class="container">
											<nav class=" navbar header-nav navbar-expand-lg main-navbar p-0">
												<a class="animated-arrow horizontal-navtoggle"><span></span></a>
												<a class="header-brand" href="index.html">
													<img src="{{URL::asset('assets/images/brand/logo.png')}}" class="header-brand-img" alt="Volgh-Admin logo">
												</a>
												...
												<div class="dropdown mr-2 ">
													<a href="#" data-toggle="dropdown" class="nav-link header-style-2 dropdown-toggle nav-link-lg d-flex">
														<span><img src="{{URL::asset('assets/images/users/10.jpg')}}" alt="profile-user" class="avatar avatar-sm brround cover-image w-32 ml-2"></span>
													</a>
									...
									<div class="horizontal-main horizontal-main2 clearfix">
										<div class="horizontal-mainwrapper container clearfix">
											<nav class="horizontalMenu clearfix"><div class="overlapblackbg"></div>
												<ul class="horizontalMenu-list">
													<li aria-haspopup="true"><span class="horizontalMenu-click"><i class="horizontalMenu-arrow fa fa-angle-down"></i></span><a href="#" class="sub-icon border-right-0"> Dashboard <i class="fa fa-angle-down horizontal-icon"></i></a>
														<ul class="sub-menu">
											...
											<div class="d-flex">
												...
												<div class="d-flex order-lg-2 mr-auto header-right-icons ">
													...
													<div class="dropdown d-md-flex message">
														...
														<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
															<a href="#" class="dropdown-item d-flex mt-2 pb-3">
																<div class="avatar avatar-md brround ml-3 d-block cover-image" data-image-src="{{URL::asset('assets/images/users/41.jpg')}}">
																	<span class="avatar-status bg-green"></span>
																</div>
																<div>
																	<strong>Madeleine</strong>
