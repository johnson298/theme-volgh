							...
							<div class="col-md-4">
								<div class="card">
									...
									<div class="card-body">
									   ...
									   <a href="#" class="float-left">Read more <i class="fa fa-angle-double-right"></i></a>
									</div>
								</div>
							</div><!-- COL-END -->
							<div class="col-md-4">
								<div class="card">
									...
									<div class="card-body">
									   <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									   <a href="#" class="float-left text-info">Read more <i class="fa fa-angle-double-right"></i></a>
									</div>
								</div>
							</div><!-- COL-END -->
							<div class="col-md-4">
								<div class="card ">
									...
									<div class="card-body">
									   <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
									   <a href="#" class="float-left text-success">Read more <i class="fa fa-angle-double-right"></i></a>
									</div>
								</div>
							</div><!-- COL-END -->
							<div class="col-md-4">
								...
								<div class="card">
									...
									<div class="card-body d-flex flex-column">
										...
										<div class="d-flex align-items-center pt-5 mt-auto">
											<div class="avatar brround avatar-md ml-3 cover-image" data-image-src="{{URL::asset('assets/images/users/18.jpg')}}"></div>
											<div>
											...
											<div class="mr-auto text-muted">
												...
												<a href="javascript:void(0)" class="icon d-none d-md-inline-block"><i class="fa fa-thumbs-o-up"></i></a>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-sm-6 col-xl-3">
								<div class="card">
									...
									<div class="card-body d-flex flex-column">
										...
										<div class="d-flex align-items-center pt-5 mt-auto">
											<div class="avatar brround avatar-md ml-3 cover-image" data-image-src="{{URL::asset('assets/images/users/16.jpg')}}"></div>
											<div>
							...
							<div class="col-sm-6 col-xl-3">
								<div class="card">
									<div class="card-body d-flex flex-column">
										...
										<div class="d-flex align-items-center pt-5 mt-auto">
											<div class="avatar  brround avatar-md ml-3 cover-image" data-image-src="{{URL::asset('assets/images/users/6.jpg')}}"></div>
											<div>
							...
							<div class="col-sm-6 col-xl-3">
								<div class="card">
									<div class="card-body d-flex flex-column">
										...
										<div class="d-flex align-items-center pt-5 mt-auto">
											<div class="avatar brround avatar-md ml-3 cover-image" data-image-src="{{URL::asset('assets/images/users/7.jpg')}}"></div>
											<div>
