									...
									<div class="card-body">
										<div class="example">
											<div class="media media-lg mt-0">
												<img class="ml-3 mb-4" src="{{URL::asset('assets/images/media/media1.jpg')}}" alt="Generic placeholder image">
							...
							<div class="col-12">
								<div class="card Relatedpost nested-media overflow-hidden">
									...
									<div class="card-body overflow-hidden">
										<div class="example">
											<div class="media media-lg mt-0">
												<img class="ml-3 mb-4" src="{{URL::asset('assets/images/media/media2.jpg')}}" alt="Generic placeholder image">
												<div class="media-body overflow-hidden">
													<h4 class="mt-0">Media heading</h4>
													Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
													<div class="media media-lg mt-3">
														<img class="ml-3 mb-4" src="{{URL::asset('assets/images/media/media3.jpg')}}" alt="Generic placeholder image">
														<div class="media-body overflow-hidden">
															<h4 class="mt-0">Media heading</h4>
															Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
														</div>
										...
										<div class="example">
											<ul class="list-unstyled">
												<li class="media media-lg mt-0 border-bottom-0">
													<img class="ml-3 mb-4" src="{{URL::asset('assets/images/media/media4.jpg')}}" alt="Generic placeholder image">
													<div class="media-body">
												...
												<li class="media media-lg my-4 border-bottom-0">
													<img class="ml-3" src="{{URL::asset('assets/images/media/media5.jpg')}}" alt="Generic placeholder image">
													<div class="media-body">
												...
												<li class="media media-lg border-bottom-0">
													<img class="ml-3" src="{{URL::asset('assets/images/media/media1.jpg')}}" alt="Generic placeholder image">
													<div class="media-body">
							...
							<div class="col-12">
								<div class="card Relatedpost nested-media">
									...
									<div class="card-body">
										<div class="example">
											<div class="media media-lg mt-0">
												<img class="align-self-start ml-3 mb-4" src="{{URL::asset('assets/images/media/media2.jpg')}}" alt="Generic placeholder image">
												<div class="media-body">
											...
											<div class="media media-lg">
												<img class="align-self-center ml-3 mb-4" src="{{URL::asset('assets/images/media/media3.jpg')}}" alt="Generic placeholder image">
												<div class="media-body">
											...
											<div class="media media-lg">
												<img class="align-self-end ml-3 mb-4" src="{{URL::asset('assets/images/media/media4.jpg')}}" alt="Generic placeholder image">
												<div class="media-body">
