							...
							<div class="col-xl-12 col-md-12">
								<div class="card cart">
											...
											<table class="table table-bordered table-vcenter text-nowrap">
												...
												<tbody>
													<tr>
														...
														<td>
															<a href="javascript:void(0)" class="btn btn-danger  btn-sm mr-3" data-toggle="tooltip" data-placement="top" title="Save for Washlist"><i class="icon icon-heart  fs-16"></i></a>
															<a href="javascript:void(0)" class="btn btn-info  btn-sm mr-3" data-toggle="tooltip" data-placement="top" title="Remove"><i class="icon icon-trash  fs-16"></i></a>
														</td>
													</tr>
													<tr>
														<td>
									...
									<div class="card-footer text-left">
										<a href="#" class="btn btn-primary"><i class="fa fa-arrow-left ml-1"></i>Continue Shopping</a>
										<a href="#" class="btn btn-success">Check out<i class="fa fa-arrow-right mr-1"></i></a>
									</div>
								</div>
							</div>
						</div><!-- COL-END -->
