											...
											<div class="d-flex">
												...
												<div class="d-flex order-lg-2 ml-auto header-right-icons ">
													...
													<div class="dropdown d-md-flex message">
														...
														<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
															<a href="#" class="dropdown-item d-flex mt-2 pb-3">
																<div class="avatar avatar-md brround mr-3 d-block cover-image" data-image-src="{{URL::asset('assets/images/users/11.jpg')}}">
																	<span class="avatar-status bg-green"></span>
																</div>
																<div>
																	<strong>Madeleine</strong>
															...
															<a href="#" class="dropdown-item d-flex pb-3">
																<div class="avatar avatar-md brround mr-3 d-block cover-image" data-image-src="{{URL::asset('assets/images/users/12.jpg')}}">
																	<span class="avatar-status bg-red"></span>
																</div>
																<div>
																	<strong>Anthony</strong>
