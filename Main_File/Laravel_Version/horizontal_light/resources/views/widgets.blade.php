						...
						<div class="row">
							<div class="col-sm-12 col-md-12 col-lg-3">
								<div class="card widgets-cards bg-primary box-primary-shadow">
									<div class="card-body d-flex justify-content-center align-items-center">
										<div class="chart-circle chart-circle-sm mr-5 mt-1" data-value="0.62" data-thickness="6" data-color="#321773"><div class="chart-circle-value text-white">70%</div></div>
							...
							<div class="col-sm-12 col-md-12 col-lg-3 ">
								<div class="card widgets-cards bg-success box-success-shadow">
									<div class="card-body d-flex justify-content-center align-items-center">
										<div class="chart-circle chart-circle-sm mr-5 mt-1" data-value="0.37" data-thickness="6" data-color="#0e8c79"><div class="chart-circle-value text-white">17%</div></div>
										<div class="wrp text-wrapper text-white">
											<p class="mt-0">6477</p>
							...
							<div class="col-sm-12 col-md-12 col-lg-3 ">
								<div class="card widgets-cards bg-warning box-warning-shadow">
									<div class="card-body d-flex justify-content-center align-items-center">
										<div class="chart-circle chart-circle-sm mr-5 mt-1" data-value="0.42" data-thickness="6" data-color="#c68806"><div class="chart-circle-value text-white">42%</div></div>
										<div class="wrp text-wrapper text-white">
											<p class="mt-0">7847</p>
							...
							<div class="col-sm-12 col-md-12 col-lg-3 ">
								<div class="card widgets-cards bg-danger box-danger-shadow">
									<div class="card-body d-flex justify-content-center align-items-center">
										<div class="chart-circle chart-circle-sm mr-5 mt-1" data-value="0.42" data-thickness="6" data-color="#c21a1a"><div class="chart-circle-value text-white">37%</div></div>
										<div class="wrp text-wrapper text-white">
											<p class="mt-0">345</p>
