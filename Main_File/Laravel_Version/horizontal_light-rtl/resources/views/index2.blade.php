									...
									<div class="card-body">
										...
										<div class="row mt-6">
											<div class="col text-center">
												<h5 class="font-weight-normal">Twitter</h5>
												<h3 class="text-xxl mb-1 social-content  number-font">21,754</h3>
												<p class="mb-2 text-muted"><span class="text-lg font-weight-700"><i class="fa fa-caret-up text-success ml-1"></i> +2.56%</span> vs last month (79.56%)</p>
											</div>
											<div class="col text-center">
												<h5 class="font-weight-normal">Google</h5>
												<h3 class="text-xxl mb-1 social-content  number-font">3,256</h3>
												<p class="mb-2 text-muted"><span class="text-lg font-weight-700"><i class="fa fa-caret-up text-success ml-1"></i> +2.56%</span> vs last month (79.56%)</p>
											</div>
											<div class="col text-center">
												<h5 class="font-weight-normal">Facebook</h5>
								...
								<div class="card">
									<div class="card-body">
										<div class="row">
											...
											<div class="counter-icon bg-secondary text-secondary box-secondary-shadow mr-auto">
								...
								<div class="card">
									<div class="card-body">
										<div class="row">
											...
											<div class="counter-icon bg-primary text-primary box-primary-shadow mr-auto">
