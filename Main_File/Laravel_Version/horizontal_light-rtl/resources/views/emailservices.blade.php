...
@section('content')
						...
						<div class="row">
							<div class="col-md-12 col-lg-3">
								...
								<div class="card">
									...
									<div class="list-group list-group-transparent">
										<a href="#" class="list-group-item list-group-item-action d-flex align-items-center">
											<span class="icon ml-3"><i class="fa fa-briefcase"></i></span>Works
										</a>
										<a href="#" class="list-group-item list-group-item-action d-flex align-items-center">
											<span class="icon ml-3"><i class="fa fa-folder-open"></i></span>Job
										</a>
										<a href="#" class="list-group-item list-group-item-action d-flex align-items-center">
											<span class="icon ml-3"><i class="fa fa-user"></i></span>Client
										</a>
										<a href="#" class="list-group-item list-group-item-action d-flex align-items-center">
											<span class="icon ml-3"><i class="fa fa-newspaper-o"></i></span>News
										</a>
									</div>
								</div>
								<div class="card">
									<div class="online-status d-flex justify-content-between align-items-center mt-4 mb-2 ml-2">
										<h5 class="card-title chat mr-3">Chats</h5>
							...
							<div class="col-md-12 col-lg-9">
								...
								<div>
									<ul class="pagination float-left mb-5">
