									...
									<div class="card-body">
										<div class="example">
											<ol class="breadcrumb1 bg-info">
												<li class="breadcrumb-item active"><i class="fa fa-star-o ml-2 text-transparant" aria-hidden="true"></i>Home</li>
											</ol>
											<ol class="breadcrumb1 bg-success">
												<li class="breadcrumb-item1"><i class="fa fa-star-o ml-2 text-white" aria-hidden="true"></i><a class="text-white" href="#">Home</a></li>
											...
											<ol class="breadcrumb1 bg-secondary">
												<li class="breadcrumb-item"><i class="fa fa-star-o ml-2 text-white" aria-hidden="true"></i><a class="text-white" href="#">Home</a></li>
