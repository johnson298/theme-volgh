									...
									<div class="col-lg-6 col-md-12 col-sm-12 col-xl-6">
										<div class="card">
											<div class="card-body text-center statistics-info">
												...
												<h2 class="mb-3  number-font">$42,567</h2>
												<p class="text-muted">Sed ut perspiciatis unde omnis accusantium doloremque</p>
											</div>
										</div>
									</div>
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="mt-4 float-right">
											<span class="ml-2"><span class="dot-label bg-info mt-1 float-left"></span>Sales</span>
											<span class="ml-5"><span class="dot-label bg-success mr-2"></span>Profit</span>
											<span class="ml-5"><span class="dot-label bg-secondary mr-2"></span>Growth</span>
										</div>
									</div>
								</div>
							</div><!-- COL END -->
						...
						<div class="row">
							<div class="col-sm-12 col-md-12 col-lg-12 col-xl-4">
								<div class="card">
									...
									<div class="card-body">
										<div class="mb-5">
											<p class="mb-2">Chrome<span class="float-left text-muted">80%</span></p>
											<div class="progress h-2">
												<div class="progress-bar bg-primary w-80 " role="progressbar"></div>
											</div>
										</div>
										<div class="mb-5">
											<p class="mb-2">Firefox<span class="float-left text-muted">70%</span></p>
											<div class="progress h-2">
												<div class="progress-bar bg-pink w-70" role="progressbar"></div>
											</div>
										</div>
										<div class="mb-5">
											<p class="mb-2">Safari<span class="float-left text-muted">80%</span></p>
											<div class="progress h-2">
												<div class="progress-bar bg-warning w-65" role="progressbar"></div>
											</div>
										</div>
										<div class="mb-5">
											<p class="mb-2">Opera<span class="float-left text-muted">80%</span></p>
											<div class="progress h-2">
												<div class="progress-bar bg-danger w-80" role="progressbar"></div>
											</div>
										</div>
										<div class="mb-5">
											<p class="mb-2">UC Browser<span class="float-left text-muted">70%</span></p>
											<div class="progress h-2">
												<div class="progress-bar bg-success w-60" role="progressbar"></div>
											</div>
										</div>
										<div class="mb-0">
											<p class="mb-2">Internet Explore<span class="float-left text-muted">50%</span></p>
											<div class="progress h-2">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
								<div class="card overflow-hidden">
									...
									<div class="chart-wrapper">
										<canvas dir="rtl" id="widgetChart3" class="chart-dropshadow-success"></canvas>
									</div>
								</div>
							</div>
						</div>
