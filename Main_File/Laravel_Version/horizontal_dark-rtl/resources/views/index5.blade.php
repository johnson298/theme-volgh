										...
										<div class="card overflow-hidden">
											<div class="card-body">
												<div class="d-flex">
													...
													<div class="counter-icon bg-primary mr-auto box-primary-shadow">
										...
										<div class="card overflow-hidden">
											<div class="card-body">
												<div class="d-flex">
													...
													<div class="counter-icon bg-secondary mr-auto box-secondary-shadow">
								...
								<div class="card">
									...
									<div class="">
										<div class="d-flex table-responsive p-3">
											...
											<div class="ml-2">
												<button type="button" class="btn btn-light btn-sm ml-2 fs-13"><i class="mdi mdi-alert-circle-outline"></i></button>
											...
											<div class="mr-auto mt-1 border-0 d-none d-md-block">
