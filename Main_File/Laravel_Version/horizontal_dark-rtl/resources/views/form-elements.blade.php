										...
										<div class="form-group mb-0">
											...
											<div class="input-group">
												...
												<div class="input-group-append">
													<button type="button" class="btn btn-primary br-tl-0 br-bl-0">Action</button>
									...
									<div class=" card-body">
										...
										<div class="d-flex">
											<div class="input-group wd-150">
												...
												<input class="form-control br-tl-0 br-bl-0" id="tp3" placeholder="Set time" type="text">
												<button class="btn btn btn-primary br-tl-5 br-tr-0 br-br-0 br-bl-5" id="setTimeButton">Set Current Time</button>
											</div><!-- input-group -->
										</div>
									</div>
								</div>
