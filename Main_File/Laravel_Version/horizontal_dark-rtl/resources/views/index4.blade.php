						...
						<div class="row">
											...
											<div class="card-body">
												...
												<ul class="list-items mt-2">
													<li class="p-1">
														...
														<span class="list-items-percentage float-left font-weight-semibold ml-4">4500,00</span>
													</li>
													<li class="p-1">
														<span class="list-label"></span>Balance
														<span class="list-items-percentage float-left font-weight-semibold ml-4">-34,645</span>
													</li>
												</ul>
											</div>
										</div>
										...
										<div class="card">
											<div class="card-body">
												...
												<ul class="list-items mt-2">
													<li class="p-1">
														<span class="list-label"></span>Budget
														<span class="list-items-percentage float-left font-weight-semibold ml-4">5678,20</span>
													</li>
													<li class="p-1">
														<span class="list-label"></span>Balance
														<span class="list-items-percentage float-left font-weight-semibold ml-4">-24,835</span>
													</li>
												</ul>
											</div>
										</div>
							...
							<div class="col-sm-12 col-lg-12 col-md-12 col-xl-7">
								<div class="card h-450">
									...
									<div class="card-body">
										<div class="row mr-5 mb-0 text-center">
											<div class="ml-5">
								...
								<div class="card  overflow-hidden">
									...
									<div class="card-body text-center">
										...
										<div class="mt-2 text-center">
											<span class="dot-label bg-info"></span><span class="ml-3">Technology</span>
											<span class="dot-label bg-secondary"></span><span class="ml-3">Furniture</span>
											<span class="dot-label bg-success"></span><span class="ml-3">Office Suppliers</span>
										</div>
									</div>
								</div>
							</div><!-- COL END -->
