									...
									<div class="card-body">
										<div class="text-wrap">
											<div class="example">
												...
												<div class="alert alert-warning" role="alert">
													<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
													<strong>Warning! </strong> Better check yourself, you are <a href="#" class="alert-link">not looking too good.</a>
												</div>
												<div class="alert alert-danger" role="alert">
													<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
									...
									<div class="card-body">
										<div class="text-wrap">
											...
											<div class="example">
												...
												<div class="alert alert-info" role="alert">
													<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
													<i class="fa fa-bell-o ml-2" aria-hidden="true"></i>Heads up! This alert needs your attention, but it is not super important.
												</div>
												<div class="alert alert-warning" role="alert">
													<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
													<i class="fa fa-exclamation ml-2" aria-hidden="true"></i> Warning! Better check yourself, you are not looking too good.
												</div>
												<div class="alert alert-danger" role="alert">
													<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
...
<div class="alert alert-info" role="alert">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<i class="fa fa-bell-o mr-2" aria-hidden="true"></i>Heads up! This alert needs your attention, but it is not super important.
</div>
<div class="alert alert-warning" role="alert">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	<i class="fa fa-exclamation mr-2" aria-hidden="true"></i> Warning! Better check yourself, you are not looking too good.
</div>
<div class="alert alert-danger" role="alert">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
										...
										<div class="text-wrap">
											<div class="example">
												<div class="row">
													...
													<div class="col-xl-2 col-md-4 mt-2 mb-2">
														<button type="button" class="btn btn-info btn-block" data-container="body" data-toggle="popover" data-popover-color="popinfo" data-placement="top" title="alert info" data-content="Heads up! This alert needs your attention, but it is not super important...">
															Show info
														</button>
													</div>
													<div class="col-xl-2 col-md-4 mt-2 mb-2">
														<button type="button" class="btn btn-block btn-warning" data-container="body" data-toggle="popover" data-popover-color="popwarning" data-placement="bottom" title="alert warning" data-content="Warning! Best check yo self, you are not looking too good..">
															Show warning
														</button>
													</div>
										...
										<div class="text-wrap mb-4">
											<div class="example">
												<div class="alert alert-info">
													...
													<hr class="message-inner-separator">
													<p>This alert needs your attention, but it is not super important.</p>
												</div>
											</div>
