							...
							<div class="col-xl-12 col-md-12">
								<div class="card cart">
									...
									<div class="card-footer text-left">
										<a href="#" class="btn btn-primary"><i class="fa fa-arrow-right ml-1"></i>Continue Shopping</a>
										<a href="#" class="btn btn-success">Check out<i class="fa fa-arrow-left mr-1"></i></a>
									</div>
								</div>
							</div>
						</div><!-- COL-END -->
