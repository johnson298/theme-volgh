									...
									<div class="card-body">
										<div class="visitor-list">
											<div class="media m-0 mt-0 border-bottom pb-3">
												<img class="avatar brround avatar-md ml-3" alt="avatra-img" src="{{URL::asset('assets/images/users/18.jpg')}}">
												<div class="media-body">
													<a href="" class="text-default font-weight-semibold">John Paige</a>
													<p class="text-muted ">Uploaded new invoices for RedBus</p>
												</div>
											</div>
											<div class="media mt-2 border-bottom pb-3">
												<img class="avatar brround avatar-md ml-3" alt="avatra-img" src="{{URL::asset('assets/images/users/20.jpg')}}">
												<div class="media-body">
