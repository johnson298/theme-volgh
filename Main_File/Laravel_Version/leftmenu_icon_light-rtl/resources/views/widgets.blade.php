								...
								<div class="card bg-primary img-card box-primary-shadow">
									<div class="card-body">
										<div class="row">
											...
											<div class="mr-auto"> <i class="fa fa-send-o text-white fs-30 mr-2 mt-2"></i> </div>
										</div>
									</div>
								</div>
							</div><!-- COL END -->
								...
								<div class="card bg-secondary img-card box-secondary-shadow">
									<div class="card-body">
										<div class="row">
											...
											<div class="mr-auto"> <i class="fa fa-bar-chart text-white fs-30 mr-2 mt-2"></i> </div>
										</div>
									</div>
								</div>
							</div><!-- COL END -->
								...
								<div class="card  bg-success img-card box-success-shadow">
									<div class="card-body">
										<div class="row">
											...
											<div class="mr-auto"> <i class="fa fa-dollar text-white fs-30 mr-2 mt-2"></i> </div>
										</div>
									</div>
								</div>
							</div><!-- COL END -->
								...
								<div class="card bg-info img-card box-info-shadow">
									<div class="card-body">
										<div class="row">
											...
											<div class="mr-auto"> <i class="fa fa-cart-plus text-white fs-30 mr-2 mt-2"></i> </div>
										</div>
									</div>
								</div>
							</div><!-- COL END -->
								...
								<div class="card">
									<div class="card-body">
										<div class="card-order">
											...
											<h2 class="text-left "><i class="mdi mdi-account-multiple icon-size float-right text-primary text-primary-shadow"></i><span>3,672</span></h2>
								...
								<div class="card ">
									<div class="card-body">
										<div class="card-widget">
											...
											<h2 class="text-left"><i class="mdi mdi-cube icon-size float-right text-success text-success-shadow"></i><span>$89,265</span></h2>
								...
								<div class="card">
									<div class="card-body">
										<div class="card-widget">
											...
											<h2 class="text-left"><i class="icon-size mdi mdi-poll-box   float-right text-warning text-warning-shadow"></i><span>$23,987</span></h2>
								...
								<div class="card ">
									<div class="card-body">
										<div class="card-widget">
											...
											<h2 class="text-left"><i class="fa fa-cart-plus icon-size float-right text-danger text-danger-shadow"></i><span>46,486</span></h2>
								...
								<div class="card">
									<div class="card-body">
										<div class="text-center">
											...
											<p class="mb-0"><span class="dot-label bg-secondary ml-2"></span>Num of Employees</p>
										</div>
									</div>
								</div>
							</div><!-- COL END -->
								...
								<div class="card">
									<div class="card-body">
										<div class="widget text-center">
											...
											<p class="mb-0"><span class="dot-label bg-success ml-2"></span>Num of Devices</p>
										</div>
									</div>
								</div>
							</div><!-- COL END -->
								...
								<div class="card">
									<div class="card-body">
										<div class="widget text-center">
											...
											<p class="mb-0"><span class="dot-label bg-warning ml-2"></span>7 licences about to expire</p>
										</div>
									</div>
								</div>
							</div><!-- COL END -->
								...
								<div class="card">
									<div class="card-body">
										<div class="widget text-center">
											...
											<p class="mb-0"><span class="dot-label bg-danger ml-2"></span>Total Running Cost</p>
										</div>
									</div>
								</div>
							</div><!-- COL END -->
						...
						<div class="row">
							<div class="col-sm-12 col-md-6 col-lg-3">
								<div class="card widgets-cards bg-primary box-primary-shadow">
									<div class="card-body d-flex justify-content-center align-items-center">
										<div class="chart-circle chart-circle-sm ml-5 mt-1" data-value="0.62" data-thickness="6" data-color="#321773"><div class="chart-circle-value text-white">70%</div></div>
							...
							<div class="col-sm-12 col-md-6 col-lg-3 ">
								<div class="card widgets-cards bg-success box-success-shadow">
									<div class="card-body d-flex justify-content-center align-items-center">
										<div class="chart-circle chart-circle-sm ml-5 mt-1" data-value="0.37" data-thickness="6" data-color="#0e8c79"><div class="chart-circle-value text-white">17%</div></div>
										<div class="wrp text-wrapper text-white">
											<p class="mt-0">6477</p>
							...
							<div class="col-sm-12 col-md-6 col-lg-3 ">
								<div class="card widgets-cards bg-warning box-warning-shadow">
									<div class="card-body d-flex justify-content-center align-items-center">
										<div class="chart-circle chart-circle-sm ml-5 mt-1" data-value="0.42" data-thickness="6" data-color="#c68806"><div class="chart-circle-value text-white">42%</div></div>
										<div class="wrp text-wrapper text-white">
											<p class="mt-0">7847</p>
							...
							<div class="col-sm-12 col-md-6 col-lg-3 ">
								<div class="card widgets-cards bg-danger box-danger-shadow">
									<div class="card-body d-flex justify-content-center align-items-center">
										<div class="chart-circle chart-circle-sm ml-5 mt-1" data-value="0.42" data-thickness="6" data-color="#c21a1a"><div class="chart-circle-value text-white">37%</div></div>
										<div class="wrp text-wrapper text-white">
											<p class="mt-0">345</p>
						...
						<div class="row">
							...
							<div class="col-lg-4 col-sm-12 p-l-0 p-r-0 col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="mx-auto chart-circle chart-circle-md mt-3 mb-4 text-center" data-value="0.75" data-thickness="8" data-color="#5e2dd8 "></div>
										<div class="text-center mt-3">
											...
											<div class="col p-1 mt-2">
												<div class="float-left">
													  <h3 class="ml-5 "><i class="fa fa-caret-up fa-1x text-primary ml-1"></i>$3.2</h3>
													  <h6 class="ml-5 pb-0 mb-0">last month</h6>
												</div>
												<div class="float-right">
													  <h3 class="mr-5"><i class="fa fa-caret-up fa-1x text-primary ml-1"></i>$2.4</h3>
										...
										<div class="card-body mt-0">
											...
											<div class="chat-details mb-1 p-3">
												<h4 class="mb-0">
													...
													<span class="float-left p-1  btn btn-sm text-default">
													<b>85</b>%</span>
												</h4>
