												...
												<div class="row">
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-primary  ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-info  ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-secondary  ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-warning  ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-danger  ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-success  ml-4"></div>
															<div>
										...
										<div class="text-wrap">
											<div class="example">
												<div class="row">
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-primary-gradient  ml-4"></div>
															<div>
																<strong>Primary</strong><br>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-info-gradient  ml-4"></div>
															<div>
																<strong>Info</strong><br>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-secondary-gradient  ml-4"></div>
															<div>
																<strong>Secondary</strong><br>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-warning-gradient  ml-4"></div>
															<div>
																<strong>Warning</strong><br>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-danger-gradient  ml-4"></div>
															<div>
																<strong>Danger</strong><br>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-success-gradient  ml-4"></div>
															<div>
																<strong>Success</strong><br>
										...
										<div class="text-wrap">
											<div class="example">
												<div class="row">
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-blue  ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-red  ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-teal  ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-azure   ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-orange  ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-cyan  ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-indigo  ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-yellow  ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-gray  ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-purple   ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-lime  ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-gray-dark  ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-pink   ml-4"></div>
															<div>
													...
													<div class="col-md-6 col-lg-4 col-sm-6">
														<div class="d-flex align-items-center mb-3 mt-3">
															<div class="w-7 h-7 bg-green  ml-4"></div>
															<div>
