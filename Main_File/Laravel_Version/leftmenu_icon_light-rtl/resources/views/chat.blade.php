										...
										<ul class="contacts mb-0">
											<li class="active">
												<div class="d-flex bd-highlight">
													...
													<div class="user_info">
														...
														<span class="dot-label bg-success"></span><span class="ml-3">online</span>
													</div>
													<div class="float-right text-right mr-auto mt-auto mb-auto">
											...
											<li>
												<div class="d-flex bd-highlight">
													...
													<div class="user_info">
														...
														<span class="dot-label bg-danger"></span><span class="ml-3">offline</span><small class="text-muted"></small>
													</div>
													<div class="float-right text-right mr-auto mt-auto mb-auto"><small>01-02-2019</small></div>
												</div>
											</li>
											<li>
												<div class="d-flex bd-highlight">
													...
													<div class="float-right text-right mr-auto mt-auto mb-auto"><small>02-02-2019</small></div>
												</div>
											</li>
											<li>
												<div class="d-flex bd-highlight">
											...
											<li>
												<div class="d-flex bd-highlight">
													...
													<div class="float-right text-right mr-auto mt-auto mb-auto"><small>03-02-2019</small></div>
												</div>
											</li>
											...
											<li class="border-bottom-0">
												<div class="d-flex bd-highlight">
													...
													<div class="float-right text-right mr-auto mt-auto mb-auto"><small>04-02-2019</small></div>
												</div>
											</li>
										</ul>
									</div>
									...
									<div class="card-footer">
										<div class="msb-reply d-flex">
											<span class="input-group-text attach_btn">
												<i class="fe fe-paperclip ml-2"></i>
												<i class="fe fe-mic ml-2"></i>
