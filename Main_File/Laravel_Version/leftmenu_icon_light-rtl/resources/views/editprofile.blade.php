								...
								<div class="card">
									...
									<div class="card-body">
										<div class="d-flex mb-3">
											<img alt="User Avatar" class="rounded-circle avatar-lg ml-2" src="{{URL::asset('assets/images/users/10.jpg')}}">
								...
								<div class="card panel-theme">
									...
									<div class="card-body no-padding">
										<ul class="list-group no-margin">
											...
											<li class="list-group-item"><i class="fa fa-globe ml-4"></i> www.abcd.com</li>
